  ...
  return (
    <div className="fw-medium col-12 m-auto pt-3 shadow-lg register-bg">
      <div className="row col-lg-10 m-auto">
        ...
        <div className="p-0 m-0 col-lg-6 m-auto p-3 details ">
          <div className="bg-white card text-dark p-3 rounded-3 shadow-lg">
            <h2 className="mb-3 fw-bold text-center" style={{color: "#081735"}}>
              Lakshya Hostel
            </h2>
            ...
            <ul className="fw-normal d-flex flex-wrap gap-2">
              <li className="btn btn-outline-dark fcl"><IoWifi className="facility_logo"/>Wifi</li>
              <li className="btn btn-outline-dark fcl"><TbAirConditioning className="facility_logo" /> Ac Rooms</li>
              <li className="btn btn-outline-dark fcl"><GiCctvCamera className="facility_logo"/> CC Tv</li>
              <li className="btn btn-outline-dark fcl"><IoWaterOutline className="facility_logo"/> Hot Water</li>
              <li className="btn btn-outline-dark fcl"><FaBowlRice className="facility_logo"/> Food</li>
              <li className="btn btn-outline-dark fcl"><FiMonitor className="facility_logo"/> Tv</li>
              <li className="btn btn-outline-dark fcl"><GiWashingMachine className="facility_logo"/> Washing Mechine</li>
              <li className="btn btn-outline-dark fcl"><RiEBike2Line className="facility_logo"/> 2 Weeler Parking</li>
              <li className="btn btn-outline-dark fcl"><FaCar className="facility_logo"/> 4 Weeler Parking</li>
            </ul>
      ...
      <div className="my-5 pt-3">
        <h3 className="fw-semibold text-center mt-lg-4 ms-3" style={{color: "#081735"}}>
        Rooms Available Now
        </h3>
        <AvailableRooms />
      </div>
      ...
      <div className='mt-5 pt-2 col-12 col-lg-10 m-auto'>
        <h5 className="fw-medium mt-lg-4 ms-3" style={{color: "#081735"}}>Similar Hostel's</h5>
        <hr className="mt-0 mb-4"/>
        <div className="row gap-3 mx-1 my-4">
          <Hostel/>
          <Hostel/>
          <Hostel/>
        </div>
        ...
        <Link to='/hostels_list' style={{textDecoration:'none'}}>
          ...
          Find More Similar Hostel's <CiCircleChevRight className="fw-bold fs-3"/>
          </button>
          </Link>
        </div>
