...
const AllRoomsOfHostel = () => {
  ...
  return (
    <div className="shadow-sm card p-0 text-dark">
      <h4 className="fw-medium text-center text-dark my-2">
        Currently Added Rooms With ManaHostel
      </h4>
        ...
        <Slider {...settings}>
          <div className="fs-6 fw-semibold">
            <img
              ...
              alt=""
            />
            <div className="my-4 text-dark-emphasis">
