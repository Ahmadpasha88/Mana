...
const Home = () => {
  ...
  const backgroundImages = useMemo(
    ...
    "url('/pexels-vlada-karpovich-7368204 (1).jpg')",
    "url('/pexels-ketut-subiyanto-4245927.jpg')"
  ],[]);
...
{loading ? (
      ...
      <section className="pt-1 pt-lg-5 mb-5 section-1" 
        ...
        style={{
          backgroundImage: `linear-gradient(174deg, #1a1a1a 7.97%, #1a1a1a 9.3%, rgba(26, 26, 26, 0.0409746) 87.47%, #1a1a1a 100%), ${backgroundImages[currentBackgroundIndex]}`,
