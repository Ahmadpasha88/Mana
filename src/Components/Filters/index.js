...
const Filters = () => {
    return (
        <div className='similar-one m-auto col-12 gap-3 p-0 pb-2 pb-lg-0'>
            <div className='m-0 p-0 col-7 col-lg-2 m-auto'>
                <label htmlFor="sortBy" className='label fw-semibold mb-1' style={{color:'#081735'}} >
                    <FaSortAmountDown className='icon fs-5' /> Sort By:
                </label>
                <select id="sortBy" className='p-2 rounded-2 col-12 border' style={{outline:'none'}}>
            ...
            <div className='m-0 p-0 col-7 col-lg-2 m-auto'>
                ...
                <select id="hostelType" className='p-2 rounded-2 col-12 border' style={{outline:'none'}}>
                    <option value="all">All</option>
            ...
            <div className='m-0 p-0 col-7 col-lg-2 m-auto'>
                ...
                <select id="priceRange" className='p-2 rounded-2 col-12 border' style={{outline:'none'}}>
                    <option value="all">All</option>
            ...
            <div className='m-0 p-0 col-7 col-lg-2 m-auto'>
                ...
                <select id="location" className='p-2 rounded-2 col-12 border' style={{outline:'none'}}>
                    <option value="all">All</option>
            ...
            <div className='m-0 p-0 col-7 col-lg-2 m-auto'>
                ...
                <select id="availability" className='p-2 rounded-2 col-12 border' style={{outline:'none'}}>
                    <option value="all">All</option>
