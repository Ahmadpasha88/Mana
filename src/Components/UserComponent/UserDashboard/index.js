    ...
    <>
     <div className="row justify-content-center px-3 py-5 m-0">
      <div className="col-12 col-lg-6 m-auto user-dashboard border rounded-3 row shadow-lg profileCard">
        <h3 className="text-center col-12 my-5 fw-bolder"  style={{color: "#081735"}}>
          Lakshya Hostel
        </h3>
            ...
            <section className="row justify-content-center m-0 p-0">
              ...
              <div className="col-12 col-lg-6 m-auto my-3 d-flex flex-column flex-wrap gap-2 px-4 rounded-3 pt-2" style={{color: "#081735"}}>
                ...
                <span className="text-nowrap fw-semibold">
                  <span className="fw-bold fs-6">Due Date:</span> 03-5-2024
                </span>
                <span className="text-nowrap fw-semibold">
            ...
            <div className="col-10 row m-auto p-0 m-0 mt-5 mb-3 gap-4">
              ...
              <Link to="/hostel_details" className="col-10 p-0 col-lg-3 m-auto shadow-lg">
                <button
                  type="button"
              ...
              <Link to="/hostels_list" className="col-10 p-0 col-lg-4 m-auto shadow-lg">
                <button
                  type="button"
