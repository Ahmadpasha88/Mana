...
const ContactUs = () => {
  ...
  return (
    <div> 
   <div className='col-12 col-lg-5 rounded-3 border m-auto my-lg-4 text-dark pb-3 p-0 m-0 register-bg pt-5'  data-aos="fade-right"
    data-aos-offset="100"
    data-aos-easing="ease-in-sine">
 
        <h2 className='text-center highlight-lines fw-semibold'>Contact Us</h2>
        <div className='row p-0 m-0 col-11 col-lg-8 m-auto gap-1 rounded-3 py-4 px-2 my-3'>
          ...
          <textarea rows="5" className="rounded-3 fs-6 p-2 mb-3 mb-md-2 input-styling" cols="5" placeholder='Enter Message'></textarea>
          <button
            type="button"
